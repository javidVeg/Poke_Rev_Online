...
import { Box, height, spacing } from "@mui/system";
  ...
  return (
    <div>
      ...
      >
        ...
        <Grid item>
          <Paper elevation={2} sx={{ display: "inline-block" }}>
            <Box sx={{ m: 2, width: "25ch" }} autoComplete="off" noValidate>
        ...
        <Grid item>
          ...
          >
            <Grid container justifyContent="center">
              <img component="image" height="250" src={images} />
            </Grid>
